...
def load_data():
    ...
    return train_test_split(X_train, y_train,test_size=0.25,
		random_state=0)# 分层采样拆分成训练集和测试集，测试集大小为原始数据集大小的 1/4
...
if __name__=='__main__':
    ...
    test_DecisionTreeClassifier_depth(X_train,X_test,y_train,y_test,maxdepth=50) # 调用 test_DecisionTreeClassifier_depth
